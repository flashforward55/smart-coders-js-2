...
function bookInfoMarkup({ book_image, title, author, description, buy_links }) {
  ...
  return `
    ...
    <li class='book_modal-links'><a href=${amazonUrl} target="_blank" rel="nofollow noopener noreferrer"> <img class='amazon-color' src='${amazon}' srcset="${amazon} 1x, ${amazon2x} 2x" alt ='Amazon Icon'></a></li>
