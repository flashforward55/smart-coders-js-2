  ...
  const markup = dataBookRender.map(
    ({ id, bookImg, author, title, description, listName, buyLinks }) => {
      ...
      <li class="shop-list__one-card" data-id=${id}>
        ...
        <li class='shop-list__links'><a href=${amazonLink} target="_blank"> <img class='amazon-color' src='${amazon}' srcset="${amazon} 1x, ${amazon2x} 2x" rel="noopener noreferrer nofollow" aria-label="Amazon link"></a></li>
